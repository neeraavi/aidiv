...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.div_progress = QtWidgets.QLabel(self.tab_4)
        self.div_progress.setGeometry(QtCore.QRect(10, 20, 1121, 421))
        self.div_progress.setFrameShape(QtWidgets.QFrame.Panel)
        self.div_progress.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.div_progress.setObjectName("div_progress")
        self.cumulative_progress = QtWidgets.QLabel(self.tab_4)
        self.cumulative_progress.setGeometry(QtCore.QRect(10, 460, 1121, 431))
        self.cumulative_progress.setFrameShape(QtWidgets.QFrame.Panel)
        self.cumulative_progress.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.cumulative_progress.setObjectName("cumulative_progress")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.div_progress.setText(_translate("MainWindow", "TextLabel"))
        self.cumulative_progress.setText(_translate("MainWindow", "TextLabel"))
